...
"14/07/30/meditations-on-moloch/", "13/09/12/the-life-cycle-of-medical-ideas/",
"13/09/28/sleep-now-by-prescription/", "14/06/15/fish-now-by-prescription/",
"14/08/16/an-iron-curtain-has-descended-upon-psychopharmacology/",
"14/05/06/evening-doc/", "14/06/30/medicine-as-not-seen-on-tv/",
"14/08/16/burdens/", "14/04/28/the-control-group-is-out-of-control/",
"13/12/17/statistical-literacy-among-doctors-now-lower-than-chance/",
"14/01/02/two-dark-side-statistics-papers/",
"13/08/29/fake-euthanasia-statistics/", "13/05/22/the-wisdom-of-the-ancients/",
...
"14/01/12/a-response-to-apophemi-on-triggers/", "14/06/14/living-by-the-sword/",
...
"14/08/14/beware-isolated-demands-for-rigor/", "13/04/06/polyamory-is-boring/",
"13/06/30/the-lottery-of-fascinations/", "13/11/19/genetic-russian-roulette/",
"14/03/17/what-universal-human-experiences-are-you-missing-without-realizing-it/"]

headers = { 'User-Agent' : 'Mozilla/4.0 (compatible; MSIE 5.5; Windows NT)' }

for post in posts:
  try:
    response = urllib2.urlopen(urllib2.Request(prefix+post, "", headers))
  except urllib2.HTTPError as e:
    print e.geturl()
    print e.read()
  htmlLines = response.readlines()
  for line in htmlLines:
    m = re.search(r'(?<=<h1 class="pjgm-posttitle">).*(?=</h1>)', line)
    if m:
      print m.group(0)
      break
  break
